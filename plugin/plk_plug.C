    ...
    for (i=1;i<argc;i++)
    {
	...
	else if (strcmp(argv[i],"-replay")==0)
	  {
        ...
        else if (strcmp(argv[i],"-saveonquit") == 0)
        {
            ...
            printf("\t -grdev, followed by the graphics device of choise (e.g. 3/xwindow; TOAs.ps/cps)\n");
	    ...
	    int recordStrokes,FILE *recordFile)
{
    ...
    do {
        ...
        cpgsci(1);
        if (strstr(gr,"/xwindow")!=NULL && graphics!=2)
        {
            ...
            /*	else if (key==61) // Add phase jump above the cursor 
                ...
                else if (key=='D') //view profile (same as middle button)
                {
                    ...
                    else
                    {
                        ...
                        if (ichan==-1 && isub==-1)
                            ...
                            sprintf(options4," -p ");
                        sprintf(str,"pav -D%s %s %s -g10/xwindow %s",options4,options1,options2,psr[0].obsn[closest].fname);
                        printf("RUNNING %s\n",str);
                    }
                    system(str);
                }
                ...
                else if (key=='v') /* View all highlighted profiles */
                {
                    ...
                    strcpy(str,"pav -DFTCp -g 10/xwindow ");
